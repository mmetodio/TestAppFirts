...
public class FormProspect extends AndroidActions{
	...
	//driver.findElement(By.id("pe.com.surgir.surgirapp:id/id_segment")).getText();
	...
	/*
	public FormProspect segmentos() {
		String segmentito = driver.findElement(By.id("pe.com.surgir.surgirapp:id/id_segment")).getText();
	//	segmentito.getText();
	//	segmento = segmentobase.substring(10, 2);
	//	System.out.println(segmentito);
		return this;
